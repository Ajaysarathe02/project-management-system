...
function ProjectHeadManageProjects() {
  ...
  const handleCardClick = async (project) => {
    ...
    setIsModalOpen(true);
    console.log("project uploader map is ", projects);
    // console.log(project);
    // console.log("this project is uploaded by ", projectUploader)
  };
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center">
                            <img className="h-10 w-10 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4GQuewxLfMh2olMxwVIVsJmu1qFf5Q4dwZw&s" alt="" />
                            <div className="ml-3">
                      ...
                      <div className="mt-6">
                        ...
                        <div className="mt-2">
                          <textarea rows="4" className="block w-full rounded-md border-gray-700 bg-gray-700 text-white shadow-sm focus:border-custom focus:ring-custom sm:text-sm" placeholder="Enter your feedback here..."></textarea>
                        </div>
                        <div className="mt-4 flex items-center space-x-4"><div className="flex items-center"><span className="text-sm text-gray-400 mr-2">Rating:</span><div className="flex items-center"><i className="fas fa-star text-yellow-400"></i><i className="fas fa-star text-yellow-400"></i><i className="fas fa-star text-yellow-400"></i><i className="fas fa-star text-yellow-400"></i><i className="far fa-star text-yellow-400"></i></div></div><select className="rounded-md border-gray-700 bg-gray-700 text-white py-2 pl-3 pr-10 text-sm focus:border-custom focus:outline-none focus:ring-custom !rounded-button"><option>Update Status</option><option>Approve</option><option>Reject</option><option>Request Revision</option></select><button className="ml-4 inline-flex items-center px-3 py-2 border border-gray-600 rounded-md text-sm text-gray-300 bg-gray-800 hover:bg-gray-700"><i className="fas fa-flag mr-2"></i>Flag Issue</button><select className="ml-4 rounded-md border-gray-700 bg-gray-700 text-white py-2 pl-3 pr-10 text-sm focus:border-custom focus:outline-none focus:ring-custom !rounded-button" id="assign-reviewer"><option>Assign Reviewer</option><option>HOD - Dr. Smith</option><option>Senior Reviewer - Dr. Johnson</option><option>Technical Lead - Mr. Chen</option><option>Domain Expert - Ms. Rodriguez</option></select></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-custom text-base font-medium text-white hover:bg-custom/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom sm:ml-3 sm:w-auto sm:text-sm !rounded-button">
                  Submit Feedback
                </button>
