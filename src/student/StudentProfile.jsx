        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-800 shadow rounded-lg p-6">
                    <div className="text-center">
                        <div className="relative inline-block">
                            ...
                            <img className="h-32 w-32 rounded-full object-cover mx-auto" src="https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png" alt="Profile photo" />
            ...
            <div className="lg:col-span-2 space-y-8">
                <div className="bg-gray-800 shadow rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-white">123 University Ave, College Town, ST 12345</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-800 shadow rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-300">Student ID/Roll Number</label>
                            <p className="mt-1 text-white">ST2023456</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300">Branch/Department</label>
                            <p className="mt-1 text-white">Computer Science</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300">Current Semester</label>
                            <p className="mt-1 text-white">6th Semester</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300">Admission Year</label>
                            <p className="mt-1 text-white">2020</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-300">CGPA</label>
                            <p className="mt-1 text-white">3.8/4.0</p>
                        </div>
                    </div>
                </div>
            </div>
